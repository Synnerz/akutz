...
// Modified version of Javet's [JavetProxyPrototypeStore]

class ProxyPrototypeStore {
    ...
    public static V8ValueObject createOrGetPrototype(
        ...
        if (EngineCache.INSTANCE.getPrivateProperties().contains(key)) {
        ...
        try (V8Scope v8Scope = v8Runtime.getV8Scope()) {
            ...
            EngineCache.INSTANCE.getPrivateProperties().add(key);
    ...
    public static V8Value getPrototype(
        ...
        String key = v8ProxyMode.name() + PREFIX + Objects.requireNonNull(clazz).getName();
        V8ValueGlobalObject globalObject = Objects.requireNonNull(v8Runtime).getGlobalObject();
        return EngineCache.INSTANCE.getPrivateProperties().contains(key) ? globalObject.getPrivateProperty(key) : null;
    }
}
