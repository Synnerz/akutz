package com.github.synnerz.akutz.api.objects.utils

import kotlin.math.sqrt

/**
 * Taken from ChatTriggers under MIT License
 * [Link](https://github.com/ChatTriggers/ChatTriggers/blob/master/src/main/kotlin/com/chattriggers/ctjs/minecraft/wrappers/utils/Vec3i.kt)
 */
open class Vec3i(
    val x: Int,
    val y: Int,
